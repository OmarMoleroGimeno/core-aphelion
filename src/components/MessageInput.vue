...
<template>
  <div class="w-full bg-transparent p-2 md:p-6 transition-colors duration-300">
    <div class="max-w-4xl mx-auto relative flex items-end gap-3">
      ...
      <Button 
        ...
        @click="handleSend"
        class="!w-12 !h-12 !shrink-0 !bg-orange-600 hover:!bg-orange-700 !border-none !shadow-md hover:!shadow-lg transition-all"
      />
    </div>
